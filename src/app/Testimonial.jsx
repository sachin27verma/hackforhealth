...
const Testimonial = () => {
  ...
  return (
    <div className=" bg-midnight ">
      <p className=" text-3xl md:text-5xl font-bold text-white text-center mb-6">Testimonial 
      ...
      <div className=" w-3/12  border-r-2 border-b-2 border-semi-blue  inline-block   text-white bg-midnight p-3">
        ...
        {/* <div className=" w-3/12  border-r-2 inline-block  h-auto  text-white bg-midnight p-3">
            <div className=" flex gap-3 mb-3 ">
                <div className=" h-[50px] w-[50px] relative ">
                    <Image src={'/doctor.png'} fill alt="avatar" className=" aspect-square rounded-full"/>
        ...
        <div className="w-3/12 inline-block  border-r-2  h-auto  text-white bg-midnight p-3">
            <div className=" flex gap-3 mb-3 ">
                <div className=" h-[50px] w-[50px] relative ">
                    <Image src={'/doctor.png'} fill alt="avatar" className=" aspect-square rounded-full"/>
        ...
        <div className=" min-w-3/12  border-r-2  h-auto  text-white bg-midnight p-3">
            <div className=" flex gap-3 mb-3 ">
                <div className=" h-[50px] w-[50px] relative ">
                    <Image src={'/doctor.png'} fill alt="avatar" className=" aspect-square rounded-full"/>
